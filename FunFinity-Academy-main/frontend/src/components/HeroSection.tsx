...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[85vh] sm:min-h-[80vh] flex flex-col justify-center overflow-hidden pt-16 sm:pt-16" aria-label="Hero section - Funfinity Academy learning platform">
      <div className="absolute inset-0 bg-gradient-to-br from-blue/5 via-orange/5 to-pink/5" aria-hidden="true" />
      <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-blue/20 rounded-full blur-3xl opacity-40" aria-hidden="true" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-pink/20 rounded-full blur-3xl opacity-40" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-orange/20 rounded-full blur-3xl opacity-30" />
